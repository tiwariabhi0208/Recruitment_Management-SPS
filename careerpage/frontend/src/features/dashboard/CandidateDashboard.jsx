      ...
      , React.createElement('div', {
        ...
        , React.createElement('div', { className: "flex items-center gap-3"  , __self: this, __source: {fileName: _jsxFileName, lineNumber: 793}}
          ...
          , React.createElement('img', {
            ...
            style: { height: "32px", objectFit: "contain" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 807}}
          )
          , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 812}}
            , React.createElement('div', {
              style: {
                color: GOLD,
                fontSize: "0.85rem",
...
, "South Point School"
            ...
            , React.createElement('div', {
              style: {
                ...
                fontSize: "0.6rem",
                letterSpacing: "0.1em",
              }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 824}}
, "CANDIDATE PORTAL"
                  ...
                  , React.createElement('div', { style: { gridColumn: "1 / -1" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1607}}
                    ...
                    , !emailEdit ? (
                      React.createElement('div', { style: { display: "flex", alignItems: "center", gap: "10px" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1610}}
                        ...
                        , React.createElement('button', { onClick: () => { setEmailEdit(true); setNewEmail(""); setOtpSent(false); setEnteredOtp(""); setOtpError(""); setEmailVerified(false); },
                          style: { background: MAROON, color: "#fff", border: "none", borderRadius: "8px", padding: "9px 16px", fontSize: "0.78rem", fontWeight: 600, cursor: "pointer", whiteSpace: "nowrap" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1612}}, "Change Email"
                      ...
                      React.createElement('div', { style: { display: "flex", flexDirection: "column", gap: "8px" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1623}}
                        , React.createElement('div', { style: { display: "flex", gap: "8px" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1624}}
                          , React.createElement('input', { type: "email", value: newEmail, onChange: (e) => setNewEmail(e.target.value), placeholder: "Enter new email address"   ,
                          ...
                          , !otpSent ? (
                            React.createElement('button', { onClick: () => { if (newEmail) { setOtpSent(true); setOtpError(""); } },
                              style: { background: MAROON, color: "#fff", border: "none", borderRadius: "8px", padding: "9px 16px", fontSize: "0.78rem", fontWeight: 600, cursor: "pointer", whiteSpace: "nowrap" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1628}}, "Send OTP"

                            )
                          ) : (
                            React.createElement('button', { onClick: () => { setOtpSent(false); setEnteredOtp(""); setOtpError(""); },
                              style: { background: "transparent", color: MAROON, border: `1px solid ${MAROON}`, borderRadius: "8px", padding: "9px 14px", fontSize: "0.78rem", fontWeight: 600, cursor: "pointer", whiteSpace: "nowrap" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1633}}, "Resend"
                        ...
                        , otpSent && (
                          React.createElement(React.Fragment, null
                            ...
                            , React.createElement('div', { style: { display: "flex", gap: "8px" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1644}}
                              , React.createElement('input', { value: enteredOtp, onChange: (e) => setEnteredOtp(e.target.value.slice(0, 6)), placeholder: "Enter 6-digit OTP"  , maxLength: 6, inputMode: "numeric",
                              ...
                              }, style: { background: "#065f46", color: "#fff", border: "none", borderRadius: "8px", padding: "9px 16px", fontSize: "0.78rem", fontWeight: 600, cursor: "pointer", whiteSpace: "nowrap" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1647}}, "Verify OTP"
                        ...
                        , React.createElement('button', { onClick: () => { setEmailEdit(false); setOtpSent(false); setEnteredOtp(""); setOtpError(""); },
                          style: { alignSelf: "flex-start", background: "transparent", color: "#6b5c5c", border: "none", fontSize: "0.75rem", cursor: "pointer", padding: 0, textDecoration: "underline" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 1663}}, "Cancel"
...
, "Professional Information"
                ...
                , React.createElement('div', { style: { marginTop: "14px", gap: "14px" }, className: "grid grid-cols-1 sm:grid-cols-2"  , __self: this, __source: {fileName: _jsxFileName, lineNumber: 1841}}
                  ...
                  , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 1862}}
                    ...
                    , React.createElement('input', { value: profile.linkedin, onChange: (e) => setProfile({ ...profile, linkedin: e.target.value }), placeholder: "https://linkedin.com/in/yourname",
                  ...
                  , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 1867}}
                    ...
                    , React.createElement('input', { value: profile.portfolio, onChange: (e) => setProfile({ ...profile, portfolio: e.target.value }), placeholder: "https://github.com/username",
                              ...
                              , uploaded ? (
                                ...
                                React.createElement(React.Fragment, null
                                  , React.createElement('label', { style: { cursor: "pointer" }, __self: this, __source: {fileName: _jsxFileName, lineNumber: 2157}}
                                    ...
                                    , React.createElement('input', { type: "file", accept: accept, style: { display: "none" }, onChange: (e) => {
